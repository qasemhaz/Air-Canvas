...
# white board button
boardBtn = ColorRect(50, 0, 100, 50, (255, 255, 0), 'Board')

# scrshoot button
scrshoot = ColorRect(1090, 500, 165, 50, (20, 56, 200), 'save')

# define a white board to draw on
whiteBoard = ColorRect(50, 60, 1020, 580, (255, 255, 255), alpha=0.5)
...
while True:
    ...
    if upFingers:
        ...
        if upFingers[1] and not whiteBoard.isOver(x, y):
            ...
            # scrshoot button
            if scrshoot.isOver(x, y) and not coolingCounter:
                coolingCounter = 10
                scrshoot.alpha = 0
                hidescr = False if hidescr else True
                scrshoot.text = 'Save' if hidescr else 'Saved!'
    ...
    # put  scrshoot buttin
    scrshoot.drawRect(frame)
    cv2.rectangle(frame, (scrshoot.x, scrshoot.y), (scrshoot.x + scrshoot.w, scrshoot.y + scrshoot.h), (255, 255, 255),
                  2)
